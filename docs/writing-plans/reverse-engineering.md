...
1. **c-asm-12 位域与联合体** — 新增章
2. **c-asm-15 C++ this 指针** — 最大缺口，游戏逆向门槛
3. **c-asm-16 虚函数表** — 紧接 this，C++ 逆向核心
4. **c-asm-14 x86-64** — 补全 64 位
5. **c-asm-13 编译器优化与 Release 形态** — 待写
6. **cracking-1/2** — 破解篇地基（方法论 + PE），含原 asm-memory.md 内容
7. **game-1 CE 入门** — 游戏篇起点
8. 其余按篇内顺序推进
